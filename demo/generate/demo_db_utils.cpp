// TODO：此文件通过工具生成（LoadProfile方法中只用了DemoUtils::MakeProfile应该不需要通过工具生成，或者合并demo_db_utils和demo_utils实现）
//
...
//
//bool DemoDBUtils::LoadProfile(RoleId roleId, UserId &userId, ServerId &serverId, std::list<std::pair<std::string, std::string>> &pDatas) {
//    serverId = 0;
//    pDatas.clear();
//    // 先从cache中加载profile数据
