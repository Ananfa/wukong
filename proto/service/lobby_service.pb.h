...
class InitRoleRequest final :
 ...
 public:
  ...
  ~InitRoleRequest() override;
  explicit constexpr InitRoleRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
