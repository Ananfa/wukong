...
bool RedisPoolManager::setCoreCache(const std::string &poolName) {
    ...
    scripts[CHECK_PASSPORT_CMD_NAME] = CHECK_PASSPORT_CMD;
    scripts[LOAD_ROLE_CMD_NAME] = LOAD_ROLE_CMD;
    scripts[SAVE_ROLE_CMD_NAME] = SAVE_ROLE_CMD;
    scripts[UPDATE_ROLE_CMD_NAME] = UPDATE_ROLE_CMD;
    scripts[SET_SESSION_CMD_NAME] = SET_SESSION_CMD;
    scripts[SET_SESSION_EXPIRE_CMD_NAME] = SET_SESSION_EXPIRE_CMD;
    scripts[REMOVE_SESSION_CMD_NAME] = REMOVE_SESSION_CMD;
    scripts[SET_RECORD_CMD_NAME] = SET_RECORD_CMD;
    scripts[REMOVE_RECORD_CMD_NAME] = REMOVE_RECORD_CMD;
    scripts[SET_RECORD_EXPIRE_CMD_NAME] = SET_RECORD_EXPIRE_CMD;
    scripts[SAVE_PROFILE_CMD_NAME] = SAVE_PROFILE_CMD;
    scripts[UPDATE_PROFILE_CMD_NAME] = UPDATE_PROFILE_CMD;
    scripts[SET_LOCATION_CMD_NAME] = SET_LOCATION_CMD;
    scripts[REMOVE_LOCATION_CMD_NAME] = REMOVE_LOCATION_CMD;
    scripts[UPDATE_LOCATION_CMD_NAME] = UPDATE_LOCATION_CMD;
    scripts[SET_LOCATION_EXPIRE_CMD_NAME] = SET_LOCATION_EXPIRE_CMD;
    scripts[SET_SCENE_LOCATION_CMD_NAME] = SET_SCENE_LOCATION_CMD;
    scripts[REMOVE_SCENE_LOCATION_CMD_NAME] = REMOVE_SCENE_LOCATION_CMD;
    scripts[SET_SCENE_LOCATION_EXPIRE_CMD_NAME] = SET_SCENE_LOCATION_EXPIRE_CMD;
