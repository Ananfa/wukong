...
int main(int argc, char * argv[]) {
    ...
    g_RecordDelegate.setCreateRecordObjectHandle([](RoleId roleId, ServerId serverId, uint32_t rToken, RecordObjectManager* mgr, std::list<std::pair<std::string, std::string>> datas) -> std::shared_ptr<RecordObject> {
