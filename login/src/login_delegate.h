...
namespace wukong {
    ...
    typedef std::function<bool (RedisConnectPool*, MysqlConnectPool*, const std::string&, const std::string&, RoleId roleId, ServerId&, std::list<std::pair<std::string, std::string>>&)> LoadProfileHandle;
